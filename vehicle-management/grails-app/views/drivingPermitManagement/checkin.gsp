...
<g:uploadForm action="saveDrivingPermit">
	<div style="width:96%; margin-left:10%; ">
		...
		<dl class="dl-horizontal">
			<dt>
				<label>
				<g:message code="label.DrivingPermit.birthDay" default="birthDay" />
				<span class="required-indicator">*</span>
				</label>
			</dt>
			<dd>
				<div class="col-xs-8">
					<g:textField value="${params.birthDay }" name="birthDay" id="birthDay" class="form-control" />
					<script type="text/javascript">
		...
		<dl class="dl-horizontal">
			...
			<dd>
				<div class="col-xs-8">
					<input type="file" id="permitPic" name="permitPic" class="form-control" required="required"/>
				</div>
			</dd>
		</dl>
		...
		<dl class="dl-horizontal">
			...
			<dd>
				<div class="col-xs-8">
				<g:textArea name="description" class="form-contorl" style="width:100%; height:80px;" required="required" ></g:textArea>
				</div>
			</dd>
		</dl>
	</div>
